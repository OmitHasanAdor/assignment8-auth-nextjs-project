...
{  user ?   <div className=" flex flex-col justify-center items-center max-w-[95%] md:max-w-[85%] gap-4 mx-auto flex-1  ">
      ...
      : <div className=" bg-white min-h-[80vh] max-w-[95%] md:max-w-[85%] mx-auto rounded-md shadow-md border-2 border-gray-200 flex-1">
