    ...
    <div className="bg-black py-10 text-white">
      <div className="mb-5 max-w-[95%] md:max-w-[70%] mx-auto space-y-5">
        <div className="flex items-center justify-center gap-2">
          ...
          />
          <h2 className="text-4xl font-bold text-center">SunCart</h2>
        </div>
        <p className="opacity-80 text-center">
          Elevating your summer adventures with premium quality gear. From UV
          protection to eco-friendly skincare, we bring you the essentials you
