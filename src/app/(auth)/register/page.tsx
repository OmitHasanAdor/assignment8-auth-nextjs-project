  ...
  return (
    <div className="">
      <div className="bg-white min-h-[80vh] max-w-125 mx-auto rounded-md shadow-md border-2 border-gray-200">
        <h1 className="text-2xl font-bold text-center py-8 border-b-2 border-gray-300">
        ...
        <div className="flex flex-col justify-center items-center py-8">
          <form onSubmit={handleSubmit(handleSignUp)}>
            <fieldset className="fieldset rounded-box w-xs p-4">
              ...
              <input
                type="password"
                {...register("password", {
                  required: "password field must required",
                })}
                className="input"
          ...
          <button className="btn btn-neutral" onClick={handleGoogleSign}>
